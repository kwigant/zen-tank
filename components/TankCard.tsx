...
import { Avatar, Chip, Divider, IconButton, Menu, Text } from "react-native-paper";
...
type tankCardProps = { id: string; tank: tank; fish: TankFish[]; addToList: boolean };
    ...
    return (
      <View style={style.tankCard}>
        ...
        <View style={[style.justifiedRow, {marginVertical: 24}]}>
          ...
          <Chip style={{borderRadius: 24, backgroundColor: theme.colors.primary,}}>{card.size} gal.</Chip>
        </View>
        ...
        <View style={style.row}>
            ...
            <Text variant="bodyMedium">{allFishInTank[0]?.waterTemperature}</Text>
          </View>
          <View style={style.row}>
            <Text variant="bodyMedium" style={{ fontWeight: "bold" }}>
              pH:{" "}
            </Text>
            <Text variant="bodyMedium">{card.size} gal.</Text>
          </View>
